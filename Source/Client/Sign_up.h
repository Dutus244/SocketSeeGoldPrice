...
namespace Client {
	...
	private: System::ComponentModel::BackgroundWorker^ Sign_up_background;
	public:
		int flag = 1;
	public:
		Sign_up(void)
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->Sign_up_background = (gcnew System::ComponentModel::BackgroundWorker());
			this->SuspendLayout();
			// 
			// Signup_username
			// 
			...
			// Sign_up_background
			// 
			this->Sign_up_background->DoWork += gcnew System::ComponentModel::DoWorkEventHandler(this, &Sign_up::Sign_up_background_DoWork);
			// 
			// Sign_up
			// 
...
#pragma endregion
	...
	private: System::Void Sign_up_background_DoWork(System::Object^ sender, System::ComponentModel::DoWorkEventArgs^ e) {
	}
};
}
